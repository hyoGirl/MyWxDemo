...
import com.github.binarywang.demo.wx.mp.config.redis.RedisConfigStorage;
...
public class WxMpConfiguration {
    ...
    public WxMpService wxMpService() {
        ...
        System.out.println("==================基础service实例化");
...
//
//                    RedisConfigStorage configStorage=new RedisConfigStorage(redisOperation);
//                    configStorage.setAppId(a.getAppId());
//                    configStorage.setSecret(a.getSecret());
//                    configStorage.setToken(a.getToken());
//                    configStorage.setAesKey(a.getAesKey());
...
//            }).collect(Collectors.toMap(RedisConfigStorage::getAppId, a -> a, (o, n) -> o)));
    ...
    public WxMpMessageRouter messageRouter(WxMpService wxMpService) {
        ...
        // 记录所有事件的日志 （异步执行）
        System.out.println("++++++++++++++++基础Handler实例化");
