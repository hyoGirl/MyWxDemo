...
public class WxMenuController {
    ...
    public String menuCreateSample(@PathVariable String appid) throws WxErrorException, MalformedURLException {
        ...
        button1.setName("QQ歌曲");
//        button1.setKey("V1001_TODAY_MUSIC");
//        button1.setUrl("https://y.qq.com/");

        WxMenuButton button11 = new WxMenuButton();
        button11.setType(MenuButtonType.VIEW);
        button11.setName("百度搜索");
        button11.setKey("V1001_baidu");
...
//        menu.getButtons().add(button2);
    ...
    public WxMpMenu menuGet(@PathVariable String appid) throws WxErrorException {
        WxMpMenu wxMpMenu = this.wxService.switchoverTo(appid).getMenuService().menuGet();
        return wxMpMenu;
    }
